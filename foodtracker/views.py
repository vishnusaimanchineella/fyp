...
def generate_report_view(request): 
   if request.method == 'POST':
        ...
        if (int(user.age)>9 and int(user.age)<13) and user.gender=="M":
            user.neededcalorieslow= 1600
            user.neededcalorieshigh= 2600
        if (int(user.age)>9 and int(user.age)<13) and user.gender=="F":
            user.neededcalorieslow= 1400
            user.neededcalorieshigh= 2200
        if (int(user.age)>=13 and int(user.age)<20) and user.gender=="M":
            user.neededcalorieslow= 2000
            user.neededcalorieshigh= 3200
        if (int(user.age)>=13 and int(user.age)<20) and user.gender=="F":
            user.neededcalorieslow= 1800
            user.neededcalorieshigh= 2400
        if (int(user.age)>=20 and int(user.age)<35) and user.gender=="M":
            user.neededcalorieslow= 2400
            user.neededcalorieshigh= 3000
        if (int(user.age)>=20 and int(user.age)<35) and user.gender=="F":
            user.neededcalorieslow= 2000
            user.neededcalorieshigh= 2600
        if (int(user.age)>=35 and int(user.age)<60) and user.gender=="M":
            user.neededcalorieslow= 2000
            user.neededcalorieshigh= 2800
        if (int(user.age)>=35 and int(user.age)<100) and user.gender=="F":
            user.neededcalorieslow= 1800
            user.neededcalorieshigh= 2200
        if (int(user.age)>=60 and int(user.age)<100) and user.gender=="M":
            user.neededcalorieslow= 2000
            user.neededcalorieshigh= 2600
